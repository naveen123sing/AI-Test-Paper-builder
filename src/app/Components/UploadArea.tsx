...
import { UploadIcon, FileTextIcon } from './Icon';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl text-gray-900">Upload Course Syllabus</h2>
        </div>
        ...
        >
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl text-gray-900 mb-2">Drag & drop your syllabus here</h3>
            {/* <h3 className="text-xl text-gray-900 mb-2">
              {isDragging ? 'Drop your file here' : 'Upload File'}
            </h3> */}

            <p className="text-gray-400 mb-6">
              Supported formats: PDF, TXT or JSON file here
            </p>
