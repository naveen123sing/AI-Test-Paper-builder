...
import { RotateCcwIcon, DownloadIcon } from './Icon';
...
export default function QuizResults({ questions, onRegenerate, onDownload }: QuizResultsProps) {
  ...
  const hasObjectiveQuestions = questions.some((question) => question.options.length > 0);
  ...
  return (
    <div className="mt-12">
      ...
      {hasObjectiveQuestions && isSubmitted && (
