...
export default function QuizCard({ questionNumber, question, options, correctAnswer, onSelectOption, answer, selectedOption, isSubmitted = false }: QuizCardProps) {
  const [isAnswerVisible, setIsAnswerVisible] = useState(false);
  const isObjectiveQuestion = options.length > 0;
  const answerText = answer || (isObjectiveQuestion && correctAnswer >= 0 ? options[correctAnswer] : '');
